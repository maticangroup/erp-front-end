                                                                        ...
                                                                        <div class="tab-content">
                                                                            ...
                                                                            <div class="tab-pane " id="tab2-2">
                                                                                <div class="form-group">
                                                                                    <select class="form-control select2-show-search"
                                                                                        ...
                                                                                        <option value="d1">Operation
                                                                                            Team 1
                                                                                        </option>
                                                                                        <option value="d2">Operation
                                                                                            Team 2
                                                                                        </option>
                                                                                        <option value="d3">Operation
                                                                                            Team 3
                                                                                        </option>
                                                                                        <option value="d4">Operation
                                                                                            Team 4
                                                                                        </option>
                                                                                        <option value="d5">Operation
                                                                                            Team 5
                                                                                        </option>
                                                                                    </select>
                                                                                </div>
                                                                            ...
                                                                            <div class="tab-pane " id="tab3-3">
                                                                                <div class="form-group">
                                                                                    <select class="form-control select2-show-search"
                                                                                            data-placeholder="Choose one (with searchbox)">
                                                                                        <option value="s1">Unit 1
                                                                                        </option>
                                                                                        <option value="s2">Unit 2
                                                                                        </option>
                                                                                        <option value="s3">Unit 3
                                                                                        </option>
                                                                                        <option value="s4">Unit 4
                                                                                        </option>
                                                                                        <option value="s5">Unit 5
                                                                                        </option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
