                                    ...
                                    <table id="example-2" class="table table-striped table-bordered nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="task-view.php" class="btn btn-dark btn-sm"><i
                                                                            ...
                                                                            <div class="panel panel-primary">
                                                                                <div class=" tab-menu-heading">
                                                                                    <div class="tabs-menu1 ">
                                                                                        <!-- Tabs -->
                                                                                        <ul class="nav panel-tabs">
                                                                                            <li class=""><a href="#tab1-1" class="active text-dark" data-toggle="tab">Employee</a></li>
                                                                                            <li><a href="#tab2-2" data-toggle="tab" class="text-dark">Operation Team</a></li>
                                                                                            <li><a href="#tab3-3" data-toggle="tab" class="text-dark">Unit</a></li>
                                                                                        </ul>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="panel-body tabs-menu-body">
                                                                                    <div class="tab-content">
                                                                                        <div class="tab-pane active " id="tab1-1">
                                                                                            <div class="form-group ">
                                                                                                <select class="form-control select2-show-search " data-placeholder="Choose one">
                                                                                                    <option value="p1">employee 1</option>
                                                                                                    <option value="p2">employee 2</option>
                                                                                                    <option value="p3">employee 3</option>
                                                                                                    <option value="p4">employee 4</option>
                                                                                                    <option value="p5">employee 5</option>
                                                                                                </select>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="tab-pane " id="tab2-2">
                                                                                            <div class="form-group">
                                                                                                <select class="form-control select2-show-search" data-placeholder="Choose one (with searchbox)">
                                                                                                    <option value="d1">Operation Team 1</option>
                                                                                                    <option value="d2">Operation Team 2</option>
                                                                                                    <option value="d3">Operation Team 3</option>
                                                                                                    <option value="d4">Operation Team 4</option>
                                                                                                    <option value="d5">Operation Team 5</option>
                                                                                                </select>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="tab-pane " id="tab3-3">
                                                                                            <div class="form-group">
                                                                                                <select class="form-control select2-show-search" data-placeholder="Choose one (with searchbox)">
                                                                                                    <option value="s1">Unit 1</option>
                                                                                                    <option value="s2">Unit 2</option>
                                                                                                    <option value="s3">Unit 3</option>
                                                                                                    <option value="s4">Unit 4</option>
                                                                                                    <option value="s5">Unit 5</option>
                                                                                                </select>
