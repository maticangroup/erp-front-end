                            ...
                            <div class="tab-pane" id="tab9">
                                <div class="table-responsive ">
                                    <table id="example-9" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            <td>Something</td>
                                            <td class="text-center">Funeral</td>
                                        ...
                                        <tr>
                                            <td>Something</td>
                                            <td class="text-center">Family Party</td>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-right ml-auto">
                    <a class="icon" href="javascript:void(0)"></a>
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#information-modal" class="btn btn-dribbble btn-sm"><i
                                ...
                                <div>
                                    ...
                                    <div class="row img-gallery pt-4">
                                        <div class="col-4">
                                            ...
                                            <button class="btn btn-pill btn-outline-dark btn-block mt-1 mb-2 btn-sm font-weight-extrabold"> Make New Order</button>
                                        </div>
                                        <div class="col-4">
                                            <a href="javascript:void(0)" data-toggle="modal" data-target="#comment-modal" class="d-block link-overlay">
                                                ...
                                                <div class="table-responsive ">
                                                    <table class="table card-table table-vcenter text-nowrap table-primary border">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">Wedding</td>
                                                            <td class="text-center">
                                                                <button type="button" class="btn-pill btn-outline-secondary btn-sm" data-type="plus" data-field="">Select</button>
                                                            </td>
                                                        </tr>
                                                        <tr>
