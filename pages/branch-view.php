...
<div class="row">
    <div id="card" class="col-xl-4 col-md-12 col-lg-12  ">
        <div class="card pb-5">
            ...
            <div class="card-body text-center pt-1 ">
                ...
                <h5 class="mt-2 mb-0"><a class="hover-primary" href="#">Executive Manager</a></h5>
                <span>Amir Nojooki</span>
                <div class="mt-3">
    ...
    <div id="branch items" class="col-xl-8 col-md-12 col-lg-12  ">
        <div id="horizontal-scroll" class="card">
            <div class="card-header">
                <div class="card-title font-weight-bold">Branch Items</div>
            </div>
                        ...
                        <ul>
                            <li>
                                <div id="employees" class="card">
                                    <div class="card-body text-center">
                                        <img src="../assets/images/svgs/png/010-call-center.png"
                                             alt="img" class="w-8 h-8 mb-4">
                                        <div class="svg-btn">
                                            <a class="btn btn-primary btn-pill" href="#">Employees</a>
                                        </div>
                                        <h3 class="mt-4">53</h3>
                                    </div>
                                </div>
                            ...
                            <li>
                                <div id="rooms" class="card">
                                    <div class="card-body text-center">
                                        <img src="../assets/images/svgs/png/053-home.png" alt="img"
                                             class="w-8 h-8 mb-4">
                                        <div class="svg-btn">
                                            <a class="btn btn-primary btn-pill" href="#">Rooms</a>
                                        </div>
                                        <h3 class="mt-4">9</h3>
                                    </div>
                                </div>
                                ...
                                <div id="invoices" class="card">
                                    <div class="card-body text-center">
                                        <img src="../assets/images/svgs/png/096-parcel.png" alt="img"
                                             class="w-8 h-8 mb-4">
                                        <div class="svg-btn">
                                            <a class="btn btn-primary btn-pill" href="#">Invoices</a>
                                        </div>
                                        <h3 class="mt-4">1255</h3>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div id="units" class="card">
                                    <div class="card-body text-center">
                                        <img src="../assets/images/svgs/png/041-distribution-1.png"
                                             alt="img" class="w-8 h-8 mb-4">
                                        <div class="svg-btn">
                                            <a class="btn btn-primary btn-pill" href="#">Units</a>
                                        </div>
                                        <h3 class="mt-4">26</h3>
                                    </div>
                                </div>
                                ...
                                <div id="contracts" class="card">
                                    <div class="card-body text-center">
                                        <img src="../assets/images/svgs/png/044-delivery-15.png"
                                             alt="img" class="w-8 h-8 mb-4">
                                        <div class="svg-btn">
                                            <a class="btn btn-primary btn-pill" href="#">Contracts</a>
                                        </div>
                                        <h3 class="mt-4">192</h3>
                                    </div>
                                </div>
                            </li>
                            <li>
...
<div class="row">
    ...
    <div class="col-xl-8 col-md-12 col-lg-12">
        <div class="card overflow-hidden">
            <div class="card-header">
                <h3 class="card-title font-weight-bold">Branch Analytics</h3>
            </div>
            <div class="card-body">
