                ...
                <div class="d-flex">
                    ...
                    <div class="d-flex order-lg-2 ml-auto">
                        ...
                        <div class="dropdown d-sm-flex d-none header-contact">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <a class="dropdown-item " href="#"> Open Contact List</a>
                ...
                <div class="d-flex order-lg-2 ml-auto">
                    ...
                    <div class="dropdown  d-md-flex header-contact">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item  " href="#">View all contact
                                list</a>
                        </div>
                    </div>
            ...
            <div class="side-app">
                ...
                <div class="mb-5">
                    <div class="page-header  mb-0">
                        <h4 class="page-title">Equipment Overview</h4>
                    </div>
                </div>
                <!--page header end-->
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title mr-2">Equipments</div>
                            ...
                            <div class="modal-body">
                                <div class="card p-3  mb-1 ">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="category"
                                                       class="form-control-label mr-1 font-weight-bold">Category:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="wd-200">
                                                <label for="Date" class="form-control-label mr-1 font-weight-bold">Purchase
                                                    Date:</label>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="purchase-deed"
                                                       class="form-control-label mr-1 font-weight-bold">Choose
                                                    Purchase
                                                    Deed:</label>
                                                <select class="form-control" id="purchase-deed">
                                                    <option></option>
                                                    <option></option>
                                                    <option></option>
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label class="form-label">Guaranty</label>
                                                <input type="text" class="form-control" name="example-text-input"
                                                       placeholder="">
                                                </label>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="purchase-deed"
                                                       class="form-control-label mr-1 font-weight-bold">Inventory:</label>
                                                <select class="form-control" id="purchase-deed">
                                ...
                                <div class="card p-3  mb-1 ">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group ">
                                                <label class="form-label">Safty Requirment</label>
                                                <div class="selectgroup selectgroup-pills">
                                                    <label class="selectgroup-item">
                                                        <input type="checkbox" name="value" value="HTML"
                                                               class="selectgroup-input" checked="">
                                                        <span class="selectgroup-button">something</span>
                                                    </label>
                                                    <label class="selectgroup-item">
                                                        <input type="checkbox" name="value" value="HTML"
                                                               class="selectgroup-input" checked="">
                ...
                <div class="modal fade" id="add-modal" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="add-modal">New Equipment</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <div class="card p-3  mb-1 ">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="wd-200">
                                                <label for="Date"
                                                       class="form-control-label mr-1 font-weight-bold">Purchase
                                                    Date:</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
