                                    ...
                                    <div class="tabs-menu ">
                                        ...
                                        <ul class="nav panel-tabs">
                                            <li class=""><a href="#tab1" class="active font-weight-bold"
                                                            data-toggle="tab">Basic Info</a></li>
                                            <li><a href="#tab2" class="font-weight-bold" data-toggle="tab">Origin</a>
                                            </li>
                                            <li><a href="#tab3" class="font-weight-bold" data-toggle="tab">Size</a></li>
                                            <li><a href="#tab4" class="font-weight-bold" data-toggle="tab">Safety
                                                    Requirement</a></li>
                                        </ul>
                                    </div>
                                </div>
