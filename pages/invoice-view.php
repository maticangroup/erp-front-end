                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-6 d-flex flex-column">
                                                        <h2 class="text-left ">Mr. Azimi Formality</h2>
                            ...
                            <div class="card-footer text-center bg-gray text-white">
                                <div class="row">
                                    <div class="col-3">
                                        ...
                                        <p>Address: Tehran-Shariati-plake 3</p>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        <i class="fas fa-at"></i>
                                        <p>Website: Farima.com </p>
                                    </div>
                                    <div class="col-3">
                                        <i class="fab fa-instagram"></i>
                                        <p>Instagram: @farima</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="wrapper w-100 ml-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <small class="text-muted ml-auto">30
                                                mins ago
                                            </small>
                                            <p class="mb-0"></p>
                                        </div>
                            ...
                            <div class="list d-flex align-items-center border-bottom p-4">
                                ...
                                <div class="wrapper w-100 ml-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            <i class="mdi mdi-clock text-muted mr-1"></i>
                                            <small class="text-muted ml-auto">2
                                                hours ago
                                            </small>
                                            <p class="mb-0"></p>
                                        </div>
                            ...
                            <div class="list d-flex align-items-center border-bottom p-4">
                                ...
                                <div class="wrapper w-100 ml-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            <i class="mdi mdi-clock text-muted mr-1"></i>
                                            <small class="text-muted ml-auto">3
                                                hours ago
                                            </small>
                                            <p class="mb-0"></p>
                                        </div>
                            ...
                            <div class="list d-flex align-items-center border-bottom p-4">
                                ...
                                <div class="wrapper w-100 ml-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            <i class="mdi mdi-clock text-muted mr-1"></i>
                                            <small class="text-muted ml-auto">4
                                                hours ago
                                            </small>
                                            <p class="mb-0"></p>
                                        </div>
                            ...
                            <div class="list d-flex align-items-center border-bottom p-4">
                                ...
                                <div class="wrapper w-100 ml-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            <i class="mdi mdi-clock text-muted mr-1"></i>
                                            <small class="text-muted ml-auto">1 days
                                                ago
                                            </small>
                                            <p class="mb-0"></p>
                                        </div>
                            ...
                            <div class="list d-flex align-items-center border-bottom p-4">
                                ...
                                <div class="wrapper w-100 ml-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            <i class="mdi mdi-clock text-muted mr-1"></i>
                                            <small class="text-muted ml-auto">45
                                                mintues ago
                                            </small>
                                            <p class="mb-0"></p>
                                        </div>
                            ...
                            <div class="list d-flex align-items-center p-4">
                                ...
                                <div class="wrapper w-100 ml-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            <i class="mdi mdi-clock text-muted mr-1"></i>
                                            <small class="text-muted ml-auto">2 days
                                                ago
                                            </small>
                                            <p class="mb-0"></p>
                                        </div>
                        ...
                        <div class="tab-pane  " id="side3">
                            <div class="list-group list-group-flush ">
                                ...
                                <div class="list-group-item d-flex  align-items-center">
                                    ...
                                    <div class="">
                                        <div class="font-weight-semibold">Mozelle
                                            Belt
                                        </div>
                                    </div>
                                    <div class="ml-auto">
                                ...
                                <div class="list-group-item d-flex  align-items-center">
                                    ...
                                    <div class="">
                                        <div class="font-weight-semibold">Florinda
                                            Carasco
                                        </div>
                                    </div>
                                    <div class="ml-auto">
                                ...
                                <div class="list-group-item d-flex  align-items-center">
                                    ...
                                    <div class="">
                                        <div class="font-weight-semibold">Alina
                                            Bernier
                                        </div>
                                    </div>
                                    <div class="ml-auto">
                                ...
                                <div class="list-group-item d-flex  align-items-center">
                                    ...
                                    <div class="">
                                        <div class="font-weight-semibold">Zula
                                            Mclaughin
                                        </div>
                                    </div>
                                    <div class="ml-auto">
                                ...
                                <div class="list-group-item d-flex  align-items-center">
                                    ...
                                    <div class="">
                                        <div class="font-weight-semibold">Isidro
                                            Heide
                                        </div>
                                    </div>
                                    <div class="ml-auto">
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse text-white-50">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © 2019 <a href="#">Getren</a>. Designed by <a href="#">Spruko</a>
                        All
                        rights reserved.
                    </div>
                </div>
