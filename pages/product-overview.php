        ...
        <div class="card bg-primary">
            <div class="card-body text-center">
                ...
                <div class="icon icon-shape bg-white rounded-circle text-white mb-3">
                    <i class="fab fa-product-hunt text-primary"></i>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive ">
                    <table id="example-2" class="table table-striped table-bordered nowrap">
                        ...
                        <tr>
                            <th class="wd-15p border-bottom-0 text-center">Products</th>
                            <th class="wd-15p border-bottom-0 text-center">Brands</th>
                            <th class="wd-10p border-bottom-0 text-center">Color</th>
                            <th class="wd-10p border-bottom-0 text-center">Size</th>
                            <th class="wd-15p border-bottom-0 text-center">Weight</th>
                            <th class="wd-15p border-bottom-0 text-center">Number of pages</th>
