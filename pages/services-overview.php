...
<div class="row">
        ...
        <div class="card bg-gradient-indigo box-shadow-0 border-primary">
            <div class="card-body">
                <div class="plan-card text-center">
                    <i class="fas fa-camera-retro fa-3x plan-icon text-white"></i>
                    <h4 class=" text-white text-uppercase mt-2">photography</h4><hr class=" my-4">
    ...
    <div class="col-xl-3 col-md-12 col-lg-6">
        <div class="card bg-gradient-teal box-shadow-0 border-success">
            <div class="card-body">
                <div class="plan-card text-center">
                    <i class="fab fa-youtube fa-3x plan-icon text-white"></i>
                    <h4 class=" text-white text-uppercase mt-2">Video</h4><hr class=" my-4">
        ...
        <div class="card bg-gradient-orange box-shadow-0 border-warning">
            <div class="card-body">
                <div class="plan-card text-center">
                    ...
                    <h4 class=" text-white text-uppercase mt-2">design & editing</h4><hr class=" my-4">
    ...
    <div class="col-xl-3 col-md-12 col-lg-6">
        <div class="card bg-gradient-blue box-shadow-0 border-info">
            <div class="card-body">
                <div class="plan-card text-center">
                    <i class="fas fa-images fa-3x plan-icon text-white"></i>
                    <h4 class=" text-white text-uppercase mt-2">professional printing</h4><hr class=" my-4">
    ...
    <div class="col-xl-12 col-md-12">
        <div class="pricing-table active rounded">
            <div class="price-header bg-gradient-indigo">
                ...
                <h4 class="title text-white mb-5">Photography</h4>
                        ...
                        <div class="box mt-8">
                            <div class="icon">
                                ...
                                <div class="info card pb-6">
                                    <h3 class="title mb-0">Aerial photography</h3>
