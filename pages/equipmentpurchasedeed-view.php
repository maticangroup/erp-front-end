                ...
                <div class="table-responsive ">
                    <table id="example-5" class="table table-striped table-bordered nowrap">
                        ...
                        <tr>
                            ...
                            <td class="text-center">Nima Yushij</td>
                                ...
                                <div class="  border-0">
                                    <div class="tabs-menu ">
                                        ...
                                        <ul class="nav panel-tabs">
                                            ...
                                            <li><a href="#tab44" class="font-weight-bold" data-toggle="tab">Guarantee</a></li>
                                            <li><a href="#tab55" class="font-weight-bold" data-toggle="tab">Delivery</a></li>
                                        </ul>
                                    </div>
                                </div>
