            ...
            <div class="side-app">
                ...
                <div class="mb-5">
                    <div class="page-header  mb-0">
                        <h4 class="page-title">Equipment Transfer Deed Overview</h4>
                    </div>
                </div>
                <!--page header end-->
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title mr-2">Equipment Transfer Deeds</div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="Requester" step="0">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="Equipment Supply Deed"
                                                           class="form-control-label mr-1 font-weight-bold">Equipment
                                                        Supply Deed:</label>
                                                    <input type="text" class="form-control " id="Equipment Supply Deed">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="wd-200">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" id="Transfer Date" type="date">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="wd-200">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" id="Transfer Time" type="time">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
=======
                                                    <label for="Delivery Method" class="form-control-label mr-1 font-weight-bold">Delivery Method:</label>
...
>>>>>>> f41c36347a31ff44cd2458ab433462f63f571961
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="Transfer Officer"
                                                           class="form-control-label mr-1 font-weight-bold">Transfer
                                                        Officer: </label>
                                                    <input type="text" class="form-control" id="Transfer Officer"
                                                           step="0">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="Address" step="0">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="Location" step="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
