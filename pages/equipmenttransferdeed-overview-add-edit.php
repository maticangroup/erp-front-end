                                ...
                                <div class="  border-0">
                                    <div class="tabs-menu ">
                                        ...
                                        <ul class="nav panel-tabs">
                                            ...
                                            <li><a href="#tab2" class="font-weight-bold" data-toggle="tab">Transfer Info </a></li>
                                            <li><a href="#tab3" class="font-weight-bold" data-toggle="tab">Delivery Place</a></li>
                                            <li><a href="#tab4" class="font-weight-bold" data-toggle="tab">Relation</a></li>
                                            <li><a href="#tab5" class="font-weight-bold" data-toggle="tab">Inform</a></li>
                                        </ul>
                                    </div>
                                </div>
