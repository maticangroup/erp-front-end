                                    ...
                                    <div class="card-body text-center pt-1 ">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <a href="#" class="btn btn-warning btn-sm"><i
                                                    class="fas fa-envelope"></i> Massage</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div id="card2" class="col-4">
                                <div class="card pb-5">
                                    <div class="flexbox align-items-center px-20 pt-20">
                                        <div class="dropdown">
                                            <a aria-expanded="false" data-toggle="dropdown" href="#"><i
                            ...
                            <div id="card3" class="col-4">
                                <div class="card pb-5">
                                    ...
                                    <div class="card-body text-center pt-1 ">
                                        ...
                                        <h5 class="mt-2 mb-0"><a class="hover-primary" href="#">Responsible
                                            Person</a></h5>
                ...
                <div class="row">
                                        ...
                                        <div class="tabs-menu1 ">
                                            ...
                                            <ul class="nav panel-tabs">
                                                ...
                                                <li><a href="#tab6" class="font-weight-bold"
                                                       data-toggle="tab">Timelines</a></li>
                                                <li><a href="#tab7" class="font-weight-bold"
                                                       data-toggle="tab">Probabilities</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="panel-body tabs-menu-body">
                                        <div class="tab-content">
                                                ...
                                                <div id="basic info" class="p-3 text-left">
                                                    ...
                                                    <div class="media mt-1 pb-2">
                                                        ...
                                                        <div class="media-body ml-5 mt-1">
                                                            <h6 class="mediafont text-dark mb-1">Customer
                                                            </h6><span class="d-block">Mr. Rezvanian</span>
                                                        </div>
                                                    </div>
                                                    <div class="media mt-1 pb-2">
                                                        <div class="mediaicon">
                                                        ...
                                                        <div class="media-body ml-5 mt-1">
                                                            <h6 class="mediafont text-dark mb-1">Responsible
                                                                Person
                                                            </h6><span class="d-block">Mr. Azimi</span>
                                                        </div>
                                                    </div>
                                                    <div class="media mt-1 pb-2">
                                                        <div class="mediaicon">
                                                        ...
                                                        <div class="media-body ml-5 mt-1">
                                                            <h6 class="mediafont text-dark mb-1">Title</h6>
                                                            <span class="d-block">Wedding</span>
                                                        </div>
                                                    </div>
                                                    <div class="media mt-1 pb-2">
                                                        <div class="mediaicon">
                                                        ...
                                                        <div class="media-body ml-5 mt-1">
                                                            <h6 class="mediafont text-dark mb-1">Source</h6>
                                                    ...
                                                    <div class="media mt-1 pb-2">
                                                        ...
                                                        <div class="media-body ml-5 mt-1">
                                                            <h6 class="mediafont text-dark mb-1">Phase</h6>
                                                            <span class="d-block">Meeting Scheduled</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane " id="tab6">
                                                <div id="timelines" class="p-3 text-left">
                                                    <div class="table-responsive">
                                                        <table class="table card-table table-vcenter table-hover">
                                                            <thead>
                                                            <tr>
                                                                <th>Create Date<br>Time</th>
                                                                <th>Closed Date<br>Time</th>
                                                                <th>Duration Time</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            <tr>
                                                                <th>12/2/93<br>21:00</th>
                                                                <td>12/3/93<br>21:00</td>
                                                                <td>1 month</td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                            ...
                                            <div class="tab-pane " id="tab7">
                                                <div id="Probabilities" class="p-3 text-left">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h3 class="card-title">Employees Estimation</h3>
                                                        </div>
                                                        <div class="card-body">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h3 class="card-title">Systems Estimation</h3>
                                                        </div>
                                                        <div class="card-body">
                    ...
                    <div class="col-6">
                        <div id="horizontal-scroll" class="card">
                            <div class="card-header">
                                <div class="card-title font-weight-bold">Deal Items</div>
                            </div>
