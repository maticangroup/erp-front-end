    ...
    <div class="page-main">
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title mr-2">Contacts</div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive ">
                                    <table id="example-2" class="table table-striped table-bordered">
                                        <thead>
                                        <tr>
                                            <th class="wd-15p border-bottom-0 text-center">First name</th>
                                            <th class="wd-15p border-bottom-0 text-center">Last name</th>
                                            <th class="wd-15p border-bottom-0 text-center">Phone number</th>
                                            <th class="wd-10p border-bottom-0 text-center">City</th>
                                            <th class="wd-25p border-bottom-0 text-center">Type</th>
                                            <th class="wd-25p border-bottom-0 text-center">Profile Status</th>
                                            <th class="border-bottom-0 text-center">Options</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                            <td class="text-center">Mohsen</td>
                                            <td class="text-center">Heshmati</td>
                                            <td class="text-center">09124557849</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">Nabavi</td>
                                            <td class="text-center">09101257849</td>
                                        ...
                                        <tr>
                                            <td class="text-center">Mohamad</td>
                                            <td class="text-center">Nikzad</td>
                                            <td class="text-center">09124517849</td>
                                            <td class="text-center">Tehran</td>
                                        ...
                                        <tr>
                                            <td class="text-center">Zahra</td>
                                            <td class="text-center">Banihashem</td>
                                            <td class="text-center">09011257849</td>
                                            <td class="text-center">Mashhad</td>
                                            <td class="text-center">Employee</td>
                                            <td class="text-center"><span class="status-icon bg-success"></span>
                                            </td>
                                            <td class="text-center">
                                        ...
                                        <tr>
                                            <td class="text-center">Zhila</td>
                                            <td class="text-center">Khodadad</td>
                                            <td class="text-center">09149417849</td>
                                            <td class="text-center">Khoramabad</td>
                                            <td class="text-center">Employee</td>
                                            <td class="text-center"><span class="status-icon bg-success"></span>
                                            </td>
                                            <td class="text-center">
                                        ...
                                        <tr>
                                            <td class="text-center">Kamran</td>
                                            <td class="text-center">Hosseini</td>
                                            <td class="text-center">09175216849</td>
                                            <td class="text-center">Yasooj</td>
                                            <td class="text-center">Vendor</td>
                                            <td class="text-center"><span class="status-icon bg-danger"></span>
                                            </td>
                                            <td class="text-center">
                                        ...
                                        <tr>
                                            <td class="text-center">Hamzeh</td>
                                            <td class="text-center">Noori</td>
                                            <td class="text-center">090821547849</td>
                                            <td class="text-center">Arak</td>
                                            <td class="text-center">Customer</td>
                                            <td class="text-center"><span class="status-icon bg-danger"></span>
                                            </td>
                                            <td class="text-center">
                                        ...
                                        <tr>
                                            <td class="text-center">Hanieh</td>
                                            <td class="text-center">Shahlayee</td>
                                            <td class="text-center">09365127849</td>
                                            <td class="text-center">Esfahan</td>
                                            <td class="text-center">Customer</td>
                                            <td class="text-center"><span class="status-icon bg-success"></span>
                                            </td>
                                            <td class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">Yaghubi</td>
                                            <td class="text-center">09350157849</td>
                                            <td class="text-center">Bandarabbas</td>
                                            <td class="text-center">Vendor</td>
                                            <td class="text-center"><span class="status-icon bg-success"></span>
                                            </td>
                                            <td class="text-center">
                                        ...
                                        <tr>
                                            <td class="text-center">Mostafa</td>
                                            <td class="text-center">Khorshidi</td>
                                            <td class="text-center">09187017849</td>
                                            <td class="text-center">Tabriz</td>
                                            <td class="text-center">Vendor</td>
                                            <td class="text-center"><span class="status-icon bg-danger"></span>
                                            </td>
                                            <td class="text-center">
                                        ...
                                        <tr>
                                            <td class="text-center">Akram</td>
                                            <td class="text-center">Shahed</td>
                                            <td class="text-center">09367127849</td>
                                            <td class="text-center">Tehran</td>
                                            <td class="text-center">Employee</td>
                                            <td class="text-center"><span class="status-icon bg-success"></span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">Yekdaneh</td>
                                            <td class="text-center">09194127849</td>
                                            <td class="text-center">Esfahan</td>
                                            <td class="text-center">Employee</td>
                                            <td class="text-center"><span class="status-icon bg-danger"></span>
                                            </td>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="example-Modal3">New Contact</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="first-Name" step="0">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="Email" class="form-control" id="email" step="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="exampleModal3-2" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">Edit Contact</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <form autocomplete="off">
                            <div class="card p-3  mb-1 ">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="last-name"
                                                   class="form-control-label mr-1 font-weight-bold">Last
                                                Name:
                                            </label>
                                            <input type="text" class="form-control" id="last-Name" step="0">
                                        </div>
                            ...
                            <div class="card p-3  mb-1 ">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="fax" class="form-control-label mr-1 font-weight-bold">Fax:
                                            </label>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    <i class="fas fa-fax"></i>
